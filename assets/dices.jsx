...
const space = <div className="dotgohst"></div>

const one = <div className="dado"
><div className="dado-border">
{  [space, space, space, 
    space, dot, space, 
    space , space, space]}
</div></div>;

const two = <div className="dado"
><div className="dado-border">
{  [dot, space, space, 
    space, space, space, 
    space , space, dot]
...
const three = <div className="dado"
><div className="dado-border">
{  [dot, space, space, 
    space, dot, space, 
    space , space, dot]
...
const four = <div className="dado"
><div className="dado-border">
{  [dot, space, dot, 
    space, space, space, 
    dot , space, dot]
}</div></div>;
const five = <div className="dado"
><div className="dado-border">
{  [dot, space, dot, 
    space, dot, space, 
    dot , space, dot]
}</div></div>;
const six = <div className="dado"
><div className="dado-border">
{  [dot, space, dot, 
    dot, space, dot, 
    dot , space, dot]
